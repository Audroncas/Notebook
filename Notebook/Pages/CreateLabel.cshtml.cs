...
{
    public class CreateLabelModel : PageModel
    {
        ...
        public CreateLabelModel(LabelsRepository repository, NotebookContext context, UserService service)
        {
